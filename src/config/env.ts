...
export const EnvConfig: EnvironmentConfig = {
  ...
  MEMORY_WARNING_THRESHOLD: getEnvNumber('MEMORY_WARNING_THRESHOLD', DEFAULT_CONFIG.MEMORY_WARNING_THRESHOLD),
  MEMORY_CRITICAL_THRESHOLD: getEnvNumber('MEMORY_CRITICAL_THRESHOLD', DEFAULT_CONFIG.MEMORY_CRITICAL_THRESHOLD),
  
  // 请求配置
  REQUEST_TIMEOUT: getEnvNumber('REQUEST_TIMEOUT', DEFAULT_CONFIG.REQUEST_TIMEOUT),
  MAX_REQUEST_SIZE: getEnvVar('MAX_REQUEST_SIZE', DEFAULT_CONFIG.MAX_REQUEST_SIZE),
  MAX_CONCURRENT_REQUESTS: getEnvNumber('MAX_CONCURRENT_REQUESTS', DEFAULT_CONFIG.MAX_CONCURRENT_REQUESTS),
  
  // 日志配置
  LOG_LEVEL: getEnvVar('LOG_LEVEL', DEFAULT_CONFIG.LOG_LEVEL),
  ENABLE_REQUEST_LOGGING: getEnvBoolean('ENABLE_REQUEST_LOGGING', DEFAULT_CONFIG.ENABLE_REQUEST_LOGGING),
  
  // 安全配置
  ENABLE_RATE_LIMITING: getEnvBoolean('ENABLE_RATE_LIMITING', DEFAULT_CONFIG.ENABLE_RATE_LIMITING),
  CORS_ORIGIN: getEnvVar('CORS_ORIGIN', DEFAULT_CONFIG.CORS_ORIGIN),
  
  // Tree-sitter配置
  PARSER_POOL_SIZE: getEnvNumber('PARSER_POOL_SIZE', DEFAULT_CONFIG.PARSER_POOL_SIZE),
  MAX_CODE_LENGTH: getEnvNumber('MAX_CODE_LENGTH', DEFAULT_CONFIG.MAX_CODE_LENGTH),
...
export function validateConfig(): void {
  ...
  // 验证内存阈值
  if (EnvConfig.MEMORY_WARNING_THRESHOLD >= EnvConfig.MEMORY_CRITICAL_THRESHOLD) {
